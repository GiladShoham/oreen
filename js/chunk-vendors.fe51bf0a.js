(self["webpackChunkwordle_clone"] = self["webpackChunkwordle_clone"] || []).push([[998], {
    444: function(e, t, n) {
        "use strict";
        n.d(t, {
            BH: function() {
          ...
          , i = function(e) {
            ...
            while (n < e.length) {
                ...
                if (i < 128)
                    ...
                    t[r++] = String.fromCharCode(56320 + (1023 & c))
                } else {
                    const o = e[n++]
                      , a = e[n++];
 ...
 */
        const g = 1e3
          ...
          , _ = 144e5
          , b = .5;
        function w(e, t=g, n=y) {
            const r = t * Math.pow(n, e)
              , i = Math.round(b * r * (Math.random() - .5) * 2);
 ...
 */
    ...
    762: function(e, t, n) {
        ...
        var r = n(238)
          ...
          , a = n(463)
          , s = n(676);
        const c = "@firebase/installations"
          , u = "0.5.5"
          , l = 1e4
          , f = `w:${u}`
          , d = "FIS_v2"
 ...
 */
        ...
        function $(e, {refreshToken: t}) {
            const n = I(e);
            return n.append("Authorization", O(t)),
            n
        }
        async function A(e) {
            const t = await e();
 ...
 */
        async function x(e, {fid: t}) {
            ...
            throw await C("Create Installation", a)
        }
        /**
 * @license
 * Copyright 2019 Google LLC
 ...
 */
        ...
        let z = null;
        function B() {
            return !z && "BroadcastChannel"in self && (z = new BroadcastChannel("[Firebase] FID Change"),
            z.onmessage = e=>{
                F(e.data.key, e.data.fid)
            }
            ),
            z
        }
 ...
 * limitations under the License.
 */
        const q = "firebase-installations-database"
          , V = 1
          , U = "firebase-installations-store";
        let K = null;
        function W() {
            return K || (K = (0,
            s.openDb)(q, V, (e=>{
        ...
        async function X(e, t) {
            const n = P(e)
              , r = await W()
              , i = r.transaction(U, "readwrite")
              , o = i.objectStore(U)
              , a = await o.get(n);
            return await o.put(t, n),
            await i.complete,
            a && a.fid === t.fid || M(e, t.fid),
            t
        }
        async function Z(e) {
            const t = P(e)
              , n = await W()
              , r = n.transaction(U, "readwrite");
            await r.objectStore(U).delete(t),
            await r.complete
        }
        async function G(e, t) {
            const n = P(e)
              ...
              , a = await o.get(n)
              , s = t(a);
            return void 0 === s ? await o.delete(n) : await o.put(s, n),
            await i.complete,
            !s || a && a.fid === s.fid || M(e, s.fid),
            s
        }
        /**
 * @license
 ...
 */
        ...
        function Q(e, t) {
            if (0 === t.registrationStatus) {
                if (!navigator.onLine) {
                    const e = Promise.reject(y.create("app-offline"));
                    return {
                        installationEntry: t,
        ...
        async function ee(e, t) {
            try {
                ...
                throw _(n) && 409 === n.customData.serverCode ? await Z(e) : await X(e, {
                    fid: t.fid,
                    registrationStatus: 0
                }),
                n
        ...
        function ne(e) {
            return G(e, (e=>{
                if (!e)
                    throw y.create("installation-not-found");
                return re(e)
            }
            ))
        }
        ...
        function ie(e) {
            return 1 === e.registrationStatus && e.registrationTime + l < Date.now()
        }
        /**
 * @license
 * Copyright 2019 Google LLC
 ...
 * limitations under the License.
 */
        async function oe({appConfig: e, platformLoggerProvider: t}, n) {
            const r = ae(e, n)
              , i = $(e, n)
              , o = t.getImmediate({
                optional: !0
            ...
            throw await C("Generate Auth Token", c)
        }
        function ae(e, {fid: t}) {
 ...
 */
        async function se(e, t=!1) {
            let n;
            const r = await G(e.appConfig, (r=>{
                if (!fe(r))
                    throw y.create("not-registered");
                const i = r.authToken;
                if (!t && de(i))
                    return r;
        ...
        async function ce(e, t) {
            ...
            while (1 === n.authToken.requestStatus)
                await S(100),
                n = await ue(e.appConfig);
            const r = n.authToken;
            return 0 === r.requestStatus ? se(e, t) : r
        }
        function ue(e) {
            return G(e, (e=>{
                if (!fe(e))
                    throw y.create("not-registered");
                const t = e.authToken;
                return ve(t) ? Object.assign(Object.assign({}, e), {
                    authToken: {
                        requestStatus: 0
                    }
                }) : e
        ...
        function ve(e) {
            return 1 === e.requestStatus && e.requestTime + l < Date.now()
        }
        /**
 * @license
 * Copyright 2019 Google LLC
 ...
 */
        async function me(e) {
            const t = e
              , {installationEntry: n, registrationPromise: r} = await Y(t.appConfig);
            return r ? r.catch(console.error) : se(t).catch(console.error),
            n.fid
        }
        /**
 * @license
 ...
 */
        async function ge(e, t=!1) {
            const n = e;
            await ye(n.appConfig);
            const r = await se(n, t);
            return r.token
        }
        async function ye(e) {
 ...
 */
        const we = "installations"
          , Ce = "installations-internal"
          , Ie = e=>{
            const t = e.getProvider("app").getImmediate()
              , n = _e(t)
              , i = (0,
            r.qX)(t, "platform-logger")
              , o = {
                app: t,
                appConfig: n,
        ...
        function Ae() {
            (0,
            r.Xd)(new a.wA(we,Ie,"PUBLIC")),
            (0,
            r.Xd)(new a.wA(Ce,$e,"PRIVATE"))
        }
        Ae(),
        (0,
        r.KN)(c, u),
 ...
 */
        const ke = "analytics"
          ...
          , xe = "origin"
          , Se = 6e4
          , Ee = "https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig"
          , Te = "https://www.googletagmanager.com/gtag/js"
          , De = new i.Yd("@firebase/analytics");
        /**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 */
        ...
        function Fe(e, t, n, r) {
            async function i(i, o, a) {
                try {
                    "event" === i ? await Me(e, t, n, o, a) : "config" === i ? await Le(e, t, n, r, o, a) : e("set", o)
                } catch (s) {
                    De.error(s)
                }
            }
 ...
 */
        const Be = {
          ...
          , He = new o.LL("analytics","Analytics",Be)
          , qe = 30
          , Ve = 1e3;
        class Ue {
            constructor(e={}, t=Ve) {
        ...
        async function Xe(e) {
            ...
            if (200 !== a.status && 304 !== a.status) {
                ...
                throw He.create("config-fetch-failed", {
                    httpStatus: a.status,
                    responseMessage: e
                })
            }
        ...
        async function Ze(e, t=Ke, n) {
            const {appId: r, apiKey: i, measurementId: o} = e.options;
            if (!r)
                throw He.create("no-app-id");
            if (!i) {
                if (o)
                    return {
                        measurementId: o,
        ...
        async function Ge(e, {throttleEndTimeMillis: t, backoffCount: n}, r, i=Ke) {
            const {appId: a, measurementId: s} = e;
            try {
                await Ye(r, t)
            } catch (c) {
                if (s)
                    return De.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${s} provided in the "measurementId" field in the local Firebase config. [${c.message}]`),
                    {
                        appId: a,
                        measurementId: s
                    };
            ...
            try {
                ...
                if (!Je(c)) {
                    ...
                    s)
                        return De.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${s} provided in the "measurementId" field in the local Firebase config. [${c.message}]`),
                        {
                            appId: a,
                            measurementId: s
                        };
                ...
                const t = 503 === Number(c.customData.httpStatus) ? (0,
                o.$s)(n, i.intervalMillis, qe) : (0,
                o.$s)(n, i.intervalMillis)
                  , u = {
                    throttleEndTimeMillis: Date.now() + t,
                    backoffCount: n + 1
                };
                return i.setThrottleMetadata(a, u),
                De.debug(`Calling attemptFetch again in ${t} millis`),
                Ge(e, u, r, i)
            }
        }
        function Ye(e, t) {
        ...
        function Je(e) {
            if (!(e instanceof o.ZR) || !e.customData)
                return !1;
 ...
 */
        async function et() {
            if (!(0,
            o.hl)())
                return De.warn(He.create("indexeddb-unavailable", {
        ...
        async function tt(e, t, n, r, i, o, a) {
            var s;
            const c = Ze(e);
            c.then((t=>{
                n[t.measurementId] = t.appId,
                e.options.measurementId && t.measurementId !== e.options.measurementId && De.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${t.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)
            }
            )).catch((e=>De.error(e))),
            t.push(c);
            const u = et().then((e=>e ? r.getId() : void 0))
              , [l,f] = await Promise.all([c, u]);
            ze() || Ne(o, l.measurementId),
            i("js", new Date);
            const d = null !== (s = null === a || void 0 === a ? void 0 : a.config) && void 0 !== s ? s : {};
            return d[xe] = "firebase",
            d.update = !0,
            null != f && (d[Oe] = f),
 ...
 */
        class nt {
            ...
            _delete() {
                return delete rt[this.app.options.appId],
                Promise.resolve()
            }
        }
        let rt = {}
          , it = [];
        const ot = {};
        let at, st, ct = "dataLayer", ut = "gtag", lt = !1;
        function ft() {
            const e = [];
            if ((0,
            o.ru)() && e.push("This is a browser extension environment."),
            (0,
            o.zI)() || e.push("Cookies are not available."),
            e.length > 0) {
                const t = e.map(((e,t)=>`(${t + 1}) ${e}`)).join(" ")
                  , n = He.create("invalid-analytics-context", {
                    errorInfo: t
                });
                De.warn(n.message)
            }
        ...
        function dt(e, t, n) {
            ...
            if (!e.options.apiKey) {
                if (!e.options.measurementId)
                    throw He.create("no-api-key");
                De.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`)
            }
            if (null != rt[r])
                throw He.create("already-exists", {
                    id: r
                });
            if (!lt) {
                Pe(ct);
                const {wrappedGtag: e, gtagCore: t} = Re(rt, it, ot, ct, ut);
                st = e,
                at = t,
                lt = !0
            }
            rt[r] = tt(e, it, ot, t, at, ct, n);
            const i = new nt(e);
            return i
        }
        /**
 ...
 */
        ...
        function mt(e, t, n, r) {
            e = (0,
            o.m9)(e),
            pt(st, rt[e.app.options.appId], t, n, r).catch((e=>De.error(e)))
        }
        ...
        function _t() {
            function e(e) {
                try {
                    const t = e.getProvider(ke).getImmediate();
                    return {
                        logEvent: (e,n,r)=>mt(t, e, n, r)
                    }
                } catch (t) {
                    throw He.create("interop-component-reg-failed", {
                        reason: t
                    })
                }
            }
            (0,
            r.Xd)(new a.wA(ke,((e,{options: t})=>{
            ...
            (0,
            r.Xd)(new a.wA("analytics-internal",e,"PRIVATE")),
            (0,
            r.KN)(gt, yt),
            (0,
            r.KN)(gt, yt, "esm2017")
    ...
    98: function(e) {
        (function() {
              ...
              , a = {
                ...
                prepareElement: function(e, t) {
                    ...
                    return Object.keys(e).forEach((function(r) {
                        var i = n.shorthand[r] || r;
                        i.match(/(body|undo|replace)/g) || ("inner" !== i ? t.setAttribute(i, e[r]) : t.textContent = e[r])
                    }
                    )),
                    t
                },
                ...
                update: function() {
                    r.length && (r.forEach((function(e, t) {
                        if (i[t] && !i[t].isEqualNode(e))
                            return e.parentElement.replaceChild(i[t], r[t]),
                            void r.splice(t, 1, i[t])
                    }
                    )),
                    i = [])
                },
                add: function(e, t, n) {
                    n.appendChild(t),
                    (void 0 === e.undo || e.undo) && r.push(t)
                },
                handle: function(e, t, n, r) {
                    var o = this;
                    e && e.forEach((function(e) {
                        var a = e.body ? o.getPlace("body") : o.getPlace(n)
                          , s = window.document.getElementById(e.id);
                        s || (s = window.document.createElement(t),
                        r = !1),
                        s.hasAttribute("id") ? o.prepareElement(e, s) : (s = o.prepareElement(e, s),
                        r ? i.push(s) : o.add(e, s, a))
                    }
                    ))
                }
            };
            function s(e, r) {
                function i(e) {
                    var t = this
                      , n = "function" === typeof t.$options.head ? t.$options.head.bind(t)() : t.$options.head;
                    n && (Object.keys(n).forEach((function(r) {
                        var i = n[r];
                        if (i) {
                            var o = "function" === typeof i ? n[r].bind(t)() : n[r];
                            "title" !== r ? a.handle(o, r, "head", e) : a[r](o)
                        }
                    }
                    )),
                    t.$emit("okHead"))
 ...
 */
        ...
        var E = Function.prototype.bind ? S : x;
        function T(e, t) {
            t = t || 0;
            var n = e.length - t
              , r = new Array(n);
        ...
        var Z, G = "__proto__"in {}, Y = "undefined" !== typeof window, J = "undefined" !== typeof WXEnvironment && !!WXEnvironment.platform, Q = J && WXEnvironment.platform.toLowerCase(), ee = Y && window.navigator.userAgent.toLowerCase(), te = ee && /msie|trident/.test(ee), ne = ee && ee.indexOf("msie 9.0") > 0, re = ee && ee.indexOf("edge/") > 0, ie = (ee && ee.indexOf("android"),
        ee && /iphone|ipad|ipod|ios/.test(ee) || "ios" === Q), oe = (ee && /chrome\/\d+/.test(ee),
        ee && /phantomjs/.test(ee),
        ee && ee.match(/firefox\/(\d+)/)), ae = {}.watch, se = !1;
        if (Y)
            try {
                var ce = {};
        ...
        var ue = function() {
            return void 0 === Z && (Z = !Y && !J && "undefined" !== typeof n.g && (n.g["process"] && "server" === n.g["process"].env.VUE_ENV)),
            Z
        }
        ...
        var Te = function(e) {
            ...
            this.vmCount = 0,
            K(e, "__ob__", this),
            Array.isArray(e) ? (G ? De(e, ke) : je(e, ke, xe),
        ...
        function Ne(e, t) {
            ...
            if (u(e) && !(e instanceof be))
                return w(e, "__ob__") && e.__ob__ instanceof Te ? n = e.__ob__ : Se && !ue() && (Array.isArray(e) || f(e)) && Object.isExtensible(e) && !e._isVue && (n = new Te(e)),
                t && n && n.vmCount++,
                n
        }
        ...
        ;
        var Re = q.optionMergeStrategies;
        function ze(e, t) {
            if (!t)
                return e;
            for (var n, r, i, o = pe ? Reflect.ownKeys(t) : Object.keys(t), a = 0; a < o.length; a++)
                ...
                "__ob__" !== n && (r = e[n],
                i = t[n],
                w(e, n) ? r !== i && f(r) && f(i) && ze(r, i) : Le(e, n, i));
            return e
        }
        function Be(e, t, n) {
            return n ? function() {
        ...
        function it(e, t, n, r, i) {
            ...
            try {
                ...
                o && !o._isVue && h(o) && !o._handled && (o.catch((function(e) {
        ...
        function ot(e, t, n) {
            if (q.errorHandler)
                try {
                    ...
                    Aa !== e && at(Aa, null, "config.errorHandler")
                }
            at(e, t, n)
        }
        function at(e, t, n) {
        ...
        if ("undefined" !== typeof Promise && fe(Promise)) {
            ...
            ,
            ct = !0
        } else if (te || "undefined" === typeof MutationObserver || !fe(MutationObserver) && "[object MutationObserverConstructor]" !== MutationObserver.toString())
            st = "undefined" !== typeof setImmediate && fe(setImmediate) ? function() {
                setImmediate(ft)
            }
            : function() {
                setTimeout(ft, 0)
        ...
        function wt(e, t) {
            function n() {
                var e = arguments
                  , r = n.fns;
                if (!Array.isArray(r))
                    return it(r, null, arguments, t, "v-on handler");
                for (var i = r.slice(), o = 0; o < i.length; o++)
                    it(i[o], null, e, t, "v-on handler")
            }
            return n.fns = e,
            n
        }
        ...
        function It(e, t, n) {
            ...
            i(s) ? r = wt([c]) : o(s.fns) && a(s.merged) ? (r = s,
            r.fns.push(c)) : r = wt([s, c]),
            r.merged = !0,
            e[t] = r
        }
        function $t(e, t, n) {
        ...
        function Ot(e) {
            return c(e) ? [Ie(e)] : Array.isArray(e) ? St(e) : void 0
        }
        function xt(e) {
        ...
        function St(e, t) {
            ...
            for (n = 0; n < e.length; n++)
                ...
                u = l[s],
                Array.isArray(r) ? r.length > 0 && (r = St(r, (t || "") + "_" + n),
                xt(r[0]) && xt(u) && (l[s] = Ie(u.text + r[0].text),
                r.shift()),
                l.push.apply(l, r)) : c(r) ? xt(u) ? l[s] = Ie(u.text + r) : "" !== r && l.push(Ie(r)) : xt(r) && xt(u) ? l[s] = Ie(u.text + r.text) : (a(e._isVList) && o(r.tag) && i(r.key) && o(t) && (r.key = "__vlist" + t + "_" + n + "__"),
                l.push(r)));
            return l
        }
        function Et(e) {
        ...
        function Mt(e, t, n) {
            var r = function() {
                ...
                e = e && "object" === typeof e && !Array.isArray(e) ? [e] : Ot(e);
                var t = e && e[0];
        ...
        function qt(e, t, n, r, i) {
            ...
            return i && r && !q.keyCodes[t] ? Ht(i, r) : o ? Ht(o, e) : r ? O(r) !== t : void 0 === e
        }
        ...
        function Gt(e, t, n, r) {
            ...
            for (var i = 0; i < e.length; i++) {
                var o = e[i];
                Array.isArray(o) ? Gt(o, t, n) : o && (o.proxy && (o.fn.proxy = !0),
                t[o.key] = o.fn)
            }
            return r && (t.$key = r),
            t
        ...
        function en(e, t, n, i, o) {
            ...
            this.slots = function() {
                return c.$slots || Lt(e.scopedSlots, c.$slots = jt(n, i)),
                c.$slots
            }
            ,
        ...
        function tn(e, t, n, i, a) {
            ...
            if (d instanceof be)
                return nn(d, n, f.parent, s, f);
            if (Array.isArray(d)) {
                for (var p = Ot(d) || [], h = new Array(p.length), v = 0; v < p.length; v++)
                    h[v] = nn(p[v], n, f.parent, s, f);
                return h
            }
        }
        ...
        var on = {
            init: function(e, t) {
                if (e.componentInstance && !e.componentInstance._isDestroyed && e.data.keepAlive) {
                    ...
                    var r = e.componentInstance = cn(e, Dn);
            ...
            insert: function(e) {
                ...
                Bn(n, "mounted")),
                e.data.keepAlive && (t._isMounted ? er(n) : Rn(n, !0))
            },
            destroy: function(e) {
        ...
        function un(e) {
            for (var t = e.hook || (e.hook = {}), n = 0; n < an.length; n++) {
                var r = an[n]
                  , i = t[r]
                  , o = on[r];
                i === o || i && i._merged || (t[r] = i ? ln(o, i) : o)
            }
        }
        function ln(e, t) {
            var n = function(n, r) {
        ...
        function vn(e, t, n, r, i) {
            ...
            r.length = 0),
            i === pn ? r = Ot(r) : i === dn && (r = kt(r)),
            "string" === typeof t) ? (s = e.$vnode && e.$vnode.ns || q.getTagNamespace(t),
            a = q.isReservedTag(t) ? new be(q.parsePlatformTagName(t),n,r,void 0,void 0,e) : n && n.pre || !o(c = Ge(e.$options, "components", t)) ? new be(t,n,r,void 0,void 0,e) : sn(c, n, e, r, t)) : a = sn(t, n, e, r);
        ...
        function mn(e, t, n) {
            ...
            o(e.children))
                for (var r = 0, s = e.children.length; r < s; r++) {
                    var c = e.children[r];
                    o(c.tag) && (i(c.ns) || a(n) && "svg" !== c.tag) && mn(c, t, n)
                }
        }
        function gn(e) {
            u(e.style) && yt(e.style),
            u(e.class) && yt(e.class)
        }
        function yn(e) {
            e._vnode = null,
            e._staticTrees = null;
            var t = e.$options
              ...
              , i = n && n.context;
            e.$slots = jt(t._renderChildren, i),
            e.$scopedSlots = r,
        ...
        function wn(e) {
            ...
            e.prototype._render = function() {
                ...
                i && (t.$scopedSlots = Lt(i.data.scopedSlots, t.$slots, t.$scopedSlots)),
                t.$vnode = i;
                try {
                    bn = t,
        ...
        function $n(e, t) {
            ...
            if (n && !o(e.owners)) {
                ...
                var f = function(e) {
                  ...
                  , v = e(d, p);
                return u(v) && (h(v) ? i(e.resolved) && v.then(d, p) : h(v.component) && (v.component.then(d, p),
                o(v.error) && (e.errorComp = Cn(v.error, t)),
                o(v.loading) && (e.loadingComp = Cn(v.loading, t),
        ...
        ir.prototype.get = function() {
            ...
            try {
                ...
                if (!this.user)
                    throw Aa;
                rt(Aa, t, 'getter for watcher "' + this.expression + '"')
            } finally {
                this.deep && yt(e),
                _e(),
                this.cleanupDeps()
        ...
        function dr(e, t) {
            ...
            for (var i in t) {
                ...
                0,
                r || (n[i] = new ir(e,a || N,N,fr)),
                i in e || pr(e, i, o)
            }
        }
        function pr(e, t, n) {
            var r = !ue();
            "function" === typeof n ? (or.get = r ? hr(t) : vr(n),
            or.set = N) : (or.get = n.get ? r && !1 !== n.cache ? hr(t) : vr(n.get) : N,
            or.set = n.set || N),
        ...
        function wr(e) {
            e.prototype._init = function(e) {
                ...
                t._uid = br++,
                t._isVue = !0,
                e && e._isComponent ? Cr(t, e) : t.$options = Ze(Ir(t.constructor), e || {}, t),
                t._renderProxy = t,
                t._self = t,
                Nn(t),
                kn(t),
        ...
        var fi = g("text,number,password,search,email,tel,url");
        function di(e) {
            if ("string" === typeof e) {
        ...
        function Ei(e, t) {
            return e.key === t.key && e.asyncFactory === t.asyncFactory && (e.tag === t.tag && e.isComment === t.isComment && o(e.data) === o(t.data) && Ti(e, t) || a(e.isAsyncPlaceholder) && i(t.asyncFactory.error))
        }
        function Ti(e, t) {
            if ("input" !== e.tag)
                return !0;
        ...
        function ji(e) {
            var t, n, r = {}, s = e.modules, u = e.nodeOps;
            ...
            function p(e, t, n, r, i, s, c) {
                if (o(e.elm) && o(s) && (e = s[c] = $e(e)),
                e.isRootInsert = !i,
                !h(e, t, n, r)) {
                    var l = e.data
                      , f = e.children
                      , d = e.tag;
                    o(d) ? (e.elm = e.ns ? u.createElementNS(e.ns, d) : u.createElement(d, e),
                    C(e),
                    _(e, f, t),
                    o(l) && w(e, t),
                    y(n, e.elm, r)) : a(e.isComment) ? (e.elm = u.createComment(e.text),
            ...
            function h(e, t, n, r) {
                ...
                if (o(i)) {
                    ...
                    if (o(i = i.hook) && o(i = i.init) && i(e, !1),
            ...
            function C(e) {
                ...
                o(t = Dn) && t !== e.context && t !== e.fnContext && o(t = t.$options._scopeId) && u.setStyleScope(e.elm, t)
            }
            ...
            function O(e, t, n, r, a) {
                var s, c, l, f, d = 0, h = 0, v = t.length - 1, m = t[0], g = t[v], y = n.length - 1, _ = n[0], b = n[y], w = !a;
                while (d <= v && h <= y)
                    i(m) ? m = t[++d] : i(g) ? g = t[--v] : Ei(m, _) ? (S(m, _, r, n, h),
                    m = t[++d],
                    _ = n[++h]) : Ei(g, b) ? (S(g, b, r, n, y),
                    g = t[--v],
                    b = n[--y]) : Ei(m, b) ? (S(m, b, r, n, y),
                    w && u.insertBefore(e, m.elm, u.nextSibling(g.elm)),
                    m = t[++d],
                    b = n[--y]) : Ei(g, _) ? (S(g, _, r, n, h),
                    w && u.insertBefore(e, g.elm, m.elm),
                    g = t[--v],
                    _ = n[++h]) : (i(s) && (s = Di(t, d, v)),
                    c = o(_.key) ? s[_.key] : x(_, t, d, v),
                    i(c) ? p(_, r, e, m.elm, !1, n, h) : (l = t[c],
                    Ei(l, _) ? (S(l, _, r, n, h),
                    t[c] = void 0,
                    w && u.insertBefore(e, l.elm, m.elm)) : p(_, r, e, m.elm, !1, n, h)),
                    _ = n[++h]);
                d > v ? (f = i(n[y + 1]) ? null : n[y + 1].elm,
                I(e, f, n, h, y, r)) : h > y && A(t, d, v)
            }
            function x(e, t, n, r) {
                for (var i = n; i < r; i++) {
                    var a = t[i];
            ...
            function S(e, t, n, s, c, l) {
                if (e !== t) {
                    ...
                    if (a(e.isAsyncPlaceholder))
                        ...
                        i(t.text) ? o(h) && o(v) ? h !== v && O(f, h, v, n, l) : o(v) ? (o(e.text) && u.setTextContent(f, ""),
                        I(f, null, v, 0, v.length - 1, n)) : o(h) ? A(h, 0, h.length - 1) : o(e.text) && u.setTextContent(f, "") : e.text !== t.text && u.setTextContent(f, t.text),
                ...
                if (!i(t)) {
                    ...
                    if (i(e))
                        ...
                        if (!d && Ei(e, t))
                            ...
                            if (d) {
                                if (1 === e.nodeType && e.hasAttribute(z) && (e.removeAttribute(z),
                                n = !0),
                                a(n) && D(e, t, f))
                                    return E(t, f, !0),
                                    e;
                            ...
                            var h = e.elm
                              , v = u.parentNode(h);
                            if (p(t, f, h._leaveCb ? null : v, u.nextSibling(h)),
                            o(t.parent)) {
                                var m = t.parent
                                  , g = b(t);
                                while (m) {
        ...
        function Li(e, t) {
            var n, r, i, o = e === xi, a = t === xi, s = Fi(e.data.directives, e.context), c = Fi(t.data.directives, t.context), u = [], l = [];
            for (n in c)
                r = s[n],
                i = c[n],
                ...
                i.oldArg = r.arg,
                zi(i, "update", t, e),
                i.def && i.def.componentUpdated && l.push(i)) : (zi(i, "bind", t, e),
            ...
            if (l.length && It(t, "postpatch", (function() {
                for (var n = 0; n < l.length; n++)
                    zi(l[n], "componentUpdated", t, e)
            }
            )),
            !o)
                for (n in s)
                    c[n] || zi(s[n], "unbind", e, e, a)
        }
        ...
        function zi(e, t, n, r, i) {
            ...
            if (o)
                try {
                    ...
                    rt(Aa, n.context, "directive " + e.name + " " + t + " hook")
                }
        }
        var Bi = [ki, Ni];
        function Hi(e, t) {
            ...
            if ((!o(n) || !1 !== n.Ctor.options.inheritAttrs) && (!i(e.data.attrs) || !i(t.data.attrs))) {
                ...
                for (r in o(l.__ob__) && (l = t.data.attrs = D({}, l)),
                l)
                    a = l[r],
                    s = u[r],
                    s !== a && qi(c, r, a, t.data.pre);
                for (r in (te || re) && l.value !== u.value && qi(c, "value", l.value),
                u)
                    i(l[r]) && (Xr(r) ? c.removeAttributeNS(Wr, Zr(r)) : qr(r) || c.removeAttribute(r))
            }
        }
        function qi(e, t, n, r) {
            r || e.tagName.indexOf("-") > -1 ? Vi(e, t, n) : Kr(t) ? Gr(n) ? e.removeAttribute(t) : (n = "allowfullscreen" === t && "EMBED" === e.tagName ? "true" : t,
            e.setAttribute(t, n)) : qr(t) ? e.setAttribute(t, Ur(t, n)) : Xr(t) ? Gr(n) ? e.removeAttributeNS(Wr, Zr(t)) : e.setAttributeNS(Wr, t, n) : Vi(e, t, n)
        }
        function Vi(e, t, n) {
            if (Gr(n))
                e.removeAttribute(t);
        ...
        function Yi(e) {
            ...
            o(e[Gi]) && (e.change = [].concat(e[Gi], e.change || []),
            delete e[Gi])
        }
        function Ji(e, t, n) {
            var r = Wi;
        ...
        function oo(e, t) {
            if (!i(e.data.domProps) || !i(t.data.domProps)) {
                ...
                for (n in o(c.__ob__) && (c = t.data.domProps = D({}, c)),
                s)
                    n in c || (a[n] = "");
                for (n in c) {
                    if (r = c[n],
                    ...
                    if ("value" === n && "PROGRESS" !== a.tagName) {
                        ...
                        var u = i(r) ? "" : String(r);
                        ao(a, u) && (a.value = u)
                    } else if ("innerHTML" === n && ai(a.tagName) && i(a.innerHTML)) {
                        ro = ro || document.createElement("div"),
                        ro.innerHTML = "<svg>" + r + "</svg>";
                        var l = ro.firstChild;
                        while (a.firstChild)
        ...
        function ao(e, t) {
            return !e.composing && ("OPTION" === e.tagName || so(e, t) || co(e, t))
        }
        function so(e, t) {
            var n = !0;
            try {
        ...
        function ho(e, t) {
            ...
            if (t) {
                ...
                while (i.componentInstance)
                    ...
                    i && i.data && (n = fo(i.data)) && D(r, n)
            }
            (n = fo(e.data)) && D(r, n);
            var o = e;
            while (o = o.parent)
                o.data && (n = fo(o.data)) && D(r, n);
            return r
        }
        var vo, mo = /^--/, go = /\s*!important$/, yo = function(e, t, n) {
            if (mo.test(t))
                e.style.setProperty(t, n);
            else if (go.test(n))
                e.style.setProperty(O(t), n.replace(go, ""), "important");
            else {
                var r = bo(t);
                if (Array.isArray(n))
                    for (var i = 0, o = n.length; i < o; i++)
        ...
        }, _o = ["Webkit", "Moz", "ms"], bo = C((function(e) {
        ...
        function wo(e, t) {
            ...
            if (!(i(n.staticStyle) && i(n.style) && i(r.staticStyle) && i(r.style))) {
                var a, s, c = t.elm, u = r.staticStyle, l = r.normalizedStyle || r.style || {}, f = u || l, d = po(t.data.style) || {};
        ...
        function $o(e, t) {
            if (t && (t = t.trim()))
                if (e.classList)
                    t.indexOf(" ") > -1 ? t.split(Io).forEach((function(t) {
        ...
        function ko(e) {
            if (e) {
                if ("object" === typeof e) {
                    var t = {};
                    return !1 !== e.css && D(t, Oo(e.name || "v")),
                    D(t, e),
                    t
                }
        ...
        var Oo = C((function(e) {
          ...
          , jo = "animation"
          , No = "animationend";
        xo && (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && (To = "WebkitTransition",
        ...
        var Po = Y ? window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout : function(e) {
            return e()
        }
        ;
        function Lo(e) {
        ...
        function Bo(e, t) {
            var n, r = window.getComputedStyle(e), i = (r[To + "Delay"] || "").split(", "), o = (r[To + "Duration"] || "").split(", "), a = Ho(i, o), s = (r[jo + "Delay"] || "").split(", "), c = (r[jo + "Duration"] || "").split(", "), u = Ho(s, c), l = 0, f = 0;
            t === So ? a > 0 && (n = So,
            l = a,
            f = o.length) : t === Eo ? u > 0 && (n = Eo,
            l = u,
            f = c.length) : (l = Math.max(a, u),
            n = l > 0 ? a > u ? So : Eo : null,
            f = n ? n === So ? o.length : c.length : 0);
            var d = n === So && zo.test(r[To + "Property"]);
            return {
                type: n,
                timeout: l,
                propCount: f,
            ...
            if (!i(r) && !o(n._enterCb) && 1 === n.nodeType) {
                ...
                if (!O || w || "" === w) {
                    ...
                    Lo((function() {
                        Fo(n, x),
                        F.cancelled || (Mo(n, E),
                        M || (Ko(P) ? setTimeout(F, P) : Ro(n, s, F)))
                    }
                    ))),
                    e.data.show && (t && t(),
                    D && D(n, F)),
        ...
        function Uo(e, t) {
            ...
            function I() {
                ...
                Lo((function() {
                    Fo(n, c),
                    C.cancelled || (Mo(n, l),
                    b || (Ko(w) ? setTimeout(C, w) : Ro(n, s, C)))
                }
                ))),
                p && p(n, C),
                _ || b || C())
        ...
        function Wo(e) {
            if (i(e))
                return !1;
            var t = e.fns;
            return o(t) ? Wo(Array.isArray(t) ? t[0] : t) : (e._length || e.length) > 1
        }
        function Xo(e, t) {
            !0 !== t.data.show && Vo(t)
        }
        ...
        var Qo = {
            inserted: function(e, t, n, r) {
                ...
                e._vOptions = [].map.call(e.options, ra)) : ("textarea" === n.tag || fi(e.type)) && (e._vModifiers = t.modifiers,
                t.modifiers.lazy || (e.addEventListener("compositionstart", ia),
                e.addEventListener("compositionend", oa),
                e.addEventListener("change", oa),
                ne && (e.vmodel = !0)))
            },
        ...
        function fa(e) {
            ...
            return t && t.Ctor.options.abstract ? fa(An(t.children)) : e
        }
        function da(e) {
            var t = {}
              , n = e.$options;
          ...
          , ya = {
            ...
            render: function(e) {
                ...
                n.length)) {
                    ...
                    l && l.data && !va(o, l) && !Pt(l) && (!l.componentInstance || !l.componentInstance._vnode.isComment)) {
        ...
        var ba = {
            ...
            render: function(e) {
                for (var t = this.tag || this.$vnode.data.tag || "span", n = Object.create(null), r = this.prevChildren = this.children, i = this.$slots.default || [], o = this.children = [], a = da(this), s = 0; s < i.length; s++) {
                    var c = i[s];
                    if (c.tag)
            ...
            updated: function() {
                ...
                e.length && this.hasMove(e[0].elm, t) && (e.forEach(wa),
                e.forEach(Ca),
                e.forEach(Ia),
                ...
                e.forEach((function(e) {
                    if (e.data.moved) {
                        ...
                        n.addEventListener(Do, n._moveCb = function e(r) {
                            r && r.target !== n || r && !/transform$/.test(r.propertyName) || (n.removeEventListener(Do, e),
                            n._moveCb = null,
                            Fo(n, t))
                        }
                        )
        ...
        Ar.config.mustUseProp = Hr,
        Ar.config.isReservedTag = si,
        Ar.config.isReservedAttr = zr,
        Ar.config.getTagNamespace = ci,
        Ar.config.isUnknownElement = li,
        D(Ar.options.directives, ua),
        D(Ar.options.components, $a),
        Ar.prototype.__patch__ = Y ? Jo : N,
        Ar.prototype.$mount = function(e, t) {
            return e = e && Y ? di(e) : void 0,
            Ln(this, e, t)
        }
        ,
        Y && setTimeout((function() {
            q.devtools && le && le.emit("init", Ar)
        }
        ), 0),
        t["Z"] = Ar
    },
 ...
 */
        ...
        const c = "@firebase/app"
          ...
          , h = "@firebase/app-check-compat"
          , v = "@firebase/app-check"
          , m = "@firebase/auth"
          , g = "@firebase/auth-compat"
          , y = "@firebase/database"
          , _ = "@firebase/database-compat"
          , b = "@firebase/functions"
          , w = "@firebase/functions-compat"
          , C = "@firebase/installations"
          , I = "@firebase/installations-compat"
          , $ = "@firebase/messaging"
          , A = "@firebase/messaging-compat"
          , k = "@firebase/performance"
          , O = "@firebase/performance-compat"
          , x = "@firebase/remote-config"
          , S = "@firebase/remote-config-compat"
          , E = "@firebase/storage"
          , T = "@firebase/storage-compat"
          , D = "@firebase/firestore"
          , j = "@firebase/firestore-compat"
          , N = "firebase"
          , P = "[DEFAULT]"
          , L = {
            [c]: "fire-core",
        ...
        function z(e) {
            const t = e.name;
            if (F.has(t))
                return l.debug(`There were multiple attempts to register component ${t}.`),
                !1;
            F.set(t, e);
 ...
 */
        function X(e) {
            z(new r.wA("platform-logger",(e=>new a(e)),"PRIVATE")),
            W(c, u, e),
            W(c, u, "esm2017"),
            W("fire-js", "")
        }
